...
public class InterpretujTest {
    ...
    public static void main(String[] args) {
        ...
        testRówności("(25-21)*(3*3)", 1); //63
        testRówności("(2*3)*(3-3)", 1); //64
        testRówności("((3-5))", -2); //65
        testRówności("(5+2)-9", -2); //66
        testRówności("(12*2)-(5*5)", -1); //67
        testRówności("5-(12/2)", -1); //68
        testRówności("(125*5)-((1000*5)/2)", 2154); //69
        testRówności("((77)-122)*2", 5); //70
        //testRówności("((3*2)*3)-(4*2)-(18*9)+111111", 2); //71
