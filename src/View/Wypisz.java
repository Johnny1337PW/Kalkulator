...
public class Wypisz {
    ...
    public static void wypiszPomoc() {
        if(!czyTest) {
            ...
            System.out.println("Program pobiera jedynie pierwszą linijkę z pliku txt!");
            System.out.println("Jeżeli plik txt jest w projekcie wystarczy wpisać !(nazwa_pliku.txt)");
            System.out.println("W przypadku gdy plik txt jest w projekcie w którymś z folderów, wystarczy wpisać !(nazwa_folderu\'nazwa_pliku)");
            System.out.println();
            System.out.println("Aby uzyskać pomoc wpisz: \"help\"");
            System.out.println("Aby usunąć wszystkie zmienne wpisz: \"clear\"");
            System.out.println("Aby wypisać wszystkie zapisane zmienne wpisz: \"list\"");
            System.out.println("Aby zakończyć wpisz: \"exit\"");
            System.out.println("--------------------------------------");
        }
    }
